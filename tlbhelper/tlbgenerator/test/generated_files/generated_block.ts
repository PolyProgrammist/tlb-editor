...
'Coins': [storeCoins, loadCoins],
'ExtraCurrencyCollection': [storeExtraCurrencyCollection, loadExtraCurrencyCollection],
'CurrencyCollection': [storeCurrencyCollection, loadCurrencyCollection],
'CommonMsgInfo': [storeCommonMsgInfo, loadCommonMsgInfo],
'CommonMsgInfoRelaxed': [storeCommonMsgInfoRelaxed, loadCommonMsgInfoRelaxed],
'TickTock': [storeTickTock, loadTickTock],
'StateInit': [storeStateInit, loadStateInit],
'StateInitWithLibs': [storeStateInitWithLibs, loadStateInitWithLibs],
'SimpleLib': [storeSimpleLib, loadSimpleLib],
'MessageAny': [storeMessageAny, loadMessageAny],
'IntermediateAddress': [storeIntermediateAddress, loadIntermediateAddress],
'MsgEnvelope': [storeMsgEnvelope, loadMsgEnvelope],
'InMsg': [storeInMsg, loadInMsg],
'ImportFees': [storeImportFees, loadImportFees],
'InMsgDescr': [storeInMsgDescr, loadInMsgDescr],
'OutMsg': [storeOutMsg, loadOutMsg],
'EnqueuedMsg': [storeEnqueuedMsg, loadEnqueuedMsg],
'OutMsgDescr': [storeOutMsgDescr, loadOutMsgDescr],
'OutMsgQueue': [storeOutMsgQueue, loadOutMsgQueue],
'ProcessedUpto': [storeProcessedUpto, loadProcessedUpto],
'ProcessedInfo': [storeProcessedInfo, loadProcessedInfo],
'IhrPendingSince': [storeIhrPendingSince, loadIhrPendingSince],
'IhrPendingInfo': [storeIhrPendingInfo, loadIhrPendingInfo],
'OutMsgQueueInfo': [storeOutMsgQueueInfo, loadOutMsgQueueInfo],
'StorageUsed': [storeStorageUsed, loadStorageUsed],
'StorageUsedShort': [storeStorageUsedShort, loadStorageUsedShort],
'StorageInfo': [storeStorageInfo, loadStorageInfo],
'Account': [storeAccount, loadAccount],
'AccountStorage': [storeAccountStorage, loadAccountStorage],
'AccountState': [storeAccountState, loadAccountState],
'AccountStatus': [storeAccountStatus, loadAccountStatus],
'ShardAccount': [storeShardAccount, loadShardAccount],
'DepthBalanceInfo': [storeDepthBalanceInfo, loadDepthBalanceInfo],
'ShardAccounts': [storeShardAccounts, loadShardAccounts],
'Transaction': [storeTransaction, loadTransaction],
'AccountBlock': [storeAccountBlock, loadAccountBlock],
'ShardAccountBlocks': [storeShardAccountBlocks, loadShardAccountBlocks],
'TrStoragePhase': [storeTrStoragePhase, loadTrStoragePhase],
'AccStatusChange': [storeAccStatusChange, loadAccStatusChange],
'TrCreditPhase': [storeTrCreditPhase, loadTrCreditPhase],
'TrComputePhase': [storeTrComputePhase, loadTrComputePhase],
'ComputeSkipReason': [storeComputeSkipReason, loadComputeSkipReason],
'TrActionPhase': [storeTrActionPhase, loadTrActionPhase],
'TrBouncePhase': [storeTrBouncePhase, loadTrBouncePhase],
'TransactionDescr': [storeTransactionDescr, loadTransactionDescr],
'SplitMergeInfo': [storeSplitMergeInfo, loadSplitMergeInfo],
'SmartContractInfo': [storeSmartContractInfo, loadSmartContractInfo],
'OutAction': [storeOutAction, loadOutAction],
'LibRef': [storeLibRef, loadLibRef],
'OutListNode': [storeOutListNode, loadOutListNode],
'ShardIdent': [storeShardIdent, loadShardIdent],
'ExtBlkRef': [storeExtBlkRef, loadExtBlkRef],
'BlockIdExt': [storeBlockIdExt, loadBlockIdExt],
'BlkMasterInfo': [storeBlkMasterInfo, loadBlkMasterInfo],
'ShardStateUnsplit': [storeShardStateUnsplit, loadShardStateUnsplit],
'ShardState': [storeShardState, loadShardState],
'LibDescr': [storeLibDescr, loadLibDescr],
'BlockInfo': [storeBlockInfo, loadBlockInfo],
'Block': [storeBlock, loadBlock],
'BlockExtra': [storeBlockExtra, loadBlockExtra],
'ValueFlow': [storeValueFlow, loadValueFlow],
'FutureSplitMerge': [storeFutureSplitMerge, loadFutureSplitMerge],
'ShardDescr': [storeShardDescr, loadShardDescr],
'ShardHashes': [storeShardHashes, loadShardHashes],
'ShardFeeCreated': [storeShardFeeCreated, loadShardFeeCreated],
'ShardFees': [storeShardFees, loadShardFees],
'ConfigParams': [storeConfigParams, loadConfigParams],
'ValidatorInfo': [storeValidatorInfo, loadValidatorInfo],
'ValidatorBaseInfo': [storeValidatorBaseInfo, loadValidatorBaseInfo],
'KeyMaxLt': [storeKeyMaxLt, loadKeyMaxLt],
'KeyExtBlkRef': [storeKeyExtBlkRef, loadKeyExtBlkRef],
'OldMcBlocksInfo': [storeOldMcBlocksInfo, loadOldMcBlocksInfo],
'Counters': [storeCounters, loadCounters],
'CreatorStats': [storeCreatorStats, loadCreatorStats],
'BlockCreateStats': [storeBlockCreateStats, loadBlockCreateStats],
'McStateExtra': [storeMcStateExtra, loadMcStateExtra],
'SigPubKey': [storeSigPubKey, loadSigPubKey],
'CryptoSignatureSimple': [storeCryptoSignatureSimple, loadCryptoSignatureSimple],
'CryptoSignature': [storeCryptoSignature, loadCryptoSignature],
'CryptoSignaturePair': [storeCryptoSignaturePair, loadCryptoSignaturePair],
'Certificate': [storeCertificate, loadCertificate],
'CertificateEnv': [storeCertificateEnv, loadCertificateEnv],
'SignedCertificate': [storeSignedCertificate, loadSignedCertificate],
'McBlockExtra': [storeMcBlockExtra, loadMcBlockExtra],
'ValidatorDescr': [storeValidatorDescr, loadValidatorDescr],
'ValidatorSet': [storeValidatorSet, loadValidatorSet],
'BurningConfig': [storeBurningConfig, loadBurningConfig],
'GlobalVersion': [storeGlobalVersion, loadGlobalVersion],
'ConfigProposalSetup': [storeConfigProposalSetup, loadConfigProposalSetup],
'ConfigVotingSetup': [storeConfigVotingSetup, loadConfigVotingSetup],
'ConfigProposal': [storeConfigProposal, loadConfigProposal],
'ConfigProposalStatus': [storeConfigProposalStatus, loadConfigProposalStatus],
'WcSplitMergeTimings': [storeWcSplitMergeTimings, loadWcSplitMergeTimings],
'WorkchainDescr': [storeWorkchainDescr, loadWorkchainDescr],
'ComplaintPricing': [storeComplaintPricing, loadComplaintPricing],
'BlockCreateFees': [storeBlockCreateFees, loadBlockCreateFees],
'StoragePrices': [storeStoragePrices, loadStoragePrices],
'GasLimitsPrices': [storeGasLimitsPrices, loadGasLimitsPrices],
'ParamLimits': [storeParamLimits, loadParamLimits],
'BlockLimits': [storeBlockLimits, loadBlockLimits],
'MsgForwardPrices': [storeMsgForwardPrices, loadMsgForwardPrices],
'CatchainConfig': [storeCatchainConfig, loadCatchainConfig],
'ConsensusConfig': [storeConsensusConfig, loadConsensusConfig],
'ValidatorTempKey': [storeValidatorTempKey, loadValidatorTempKey],
'ValidatorSignedTempKey': [storeValidatorSignedTempKey, loadValidatorSignedTempKey],
'MisbehaviourPunishmentConfig': [storeMisbehaviourPunishmentConfig, loadMisbehaviourPunishmentConfig],
'SizeLimitsConfig': [storeSizeLimitsConfig, loadSizeLimitsConfig],
'SuspendedAddressList': [storeSuspendedAddressList, loadSuspendedAddressList],
'OracleBridgeParams': [storeOracleBridgeParams, loadOracleBridgeParams],
'JettonBridgePrices': [storeJettonBridgePrices, loadJettonBridgePrices],
'JettonBridgeParams': [storeJettonBridgeParams, loadJettonBridgeParams],
'BlockSignaturesPure': [storeBlockSignaturesPure, loadBlockSignaturesPure],
'BlockSignatures': [storeBlockSignatures, loadBlockSignatures],
'BlockProof': [storeBlockProof, loadBlockProof],
'TopBlockDescr': [storeTopBlockDescr, loadTopBlockDescr],
'TopBlockDescrSet': [storeTopBlockDescrSet, loadTopBlockDescrSet],
'ProducerInfo': [storeProducerInfo, loadProducerInfo],
'ComplaintDescr': [storeComplaintDescr, loadComplaintDescr],
'ValidatorComplaint': [storeValidatorComplaint, loadValidatorComplaint],
'ValidatorComplaintStatus': [storeValidatorComplaintStatus, loadValidatorComplaintStatus],
'VmStackValue': [storeVmStackValue, loadVmStackValue],
'VmCellSlice': [storeVmCellSlice, loadVmCellSlice],
'VmStack': [storeVmStack, loadVmStack],
'VmSaveList': [storeVmSaveList, loadVmSaveList],
'VmGasLimits': [storeVmGasLimits, loadVmGasLimits],
'VmLibraries': [storeVmLibraries, loadVmLibraries],
'VmControlData': [storeVmControlData, loadVmControlData],
'VmCont': [storeVmCont, loadVmCont],
'DNS_RecordSet': [storeDNS_RecordSet, loadDNS_RecordSet],
'Text': [storeText, loadText],
'DNSRecord': [storeDNSRecord, loadDNSRecord],
'ProtoList': [storeProtoList, loadProtoList],
'Protocol': [storeProtocol, loadProtocol],
'SmcCapList': [storeSmcCapList, loadSmcCapList],
'SmcCapability': [storeSmcCapability, loadSmcCapability],
'ChanConfig': [storeChanConfig, loadChanConfig],
'ChanState': [storeChanState, loadChanState],
'ChanPromise': [storeChanPromise, loadChanPromise],
'ChanSignedPromise': [storeChanSignedPromise, loadChanSignedPromise],
'ChanMsg': [storeChanMsg, loadChanMsg],
'ChanSignedMsg': [storeChanSignedMsg, loadChanSignedMsg],
'ChanOp': [storeChanOp, loadChanOp],
'ChanData': [storeChanData, loadChanData]
}