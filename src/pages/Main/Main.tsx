...
export const Main: React.FC = () => {
	...
	return (
		<Flex as="main" flexGrow={1}>
			...
			<Box flexGrow={1}>
				<Editor defaultLanguage="javascript" value={code} />
			</Box>
		</Flex>
	);
};
